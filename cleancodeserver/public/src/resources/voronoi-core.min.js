...
this.vertices=[];this.edges=[];this.cells=[]};Voronoi.prototype.sqrt=Math.sqrt;Voronoi.prototype.abs=Math.abs;Voronoi.prototype.Îµ=Voronoi.Îµ=1e-9;
Voronoi.prototype.invÎµ=Voronoi.invÎµ=1/Voronoi.Îµ;Voronoi.prototype.equalWithEpsilon=function(d,c){return this.abs(d-c)<1e-9
...
}}e++}n.closeMe=false}};Voronoi.prototype.quantizeSites=function(c){var b=this.Îµ,d=c.length,a;while(d--){a=c[d];a.x=Math.floor(a.x/b)*b;
